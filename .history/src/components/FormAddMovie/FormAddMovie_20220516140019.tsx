...
const FormAddMovie: React.FC = () => {
  ...
  const [validateTitleMovie, setValidateTitleMovie] = useState<boolean>(true)
  const { register, handleSubmit, errore } = useForm<FormAddMovieProps>();

  const handleSubmitToLocalStorage = handleSubmit((data) => {
    console.log(data)
  })
  console.log(value)
  return (
