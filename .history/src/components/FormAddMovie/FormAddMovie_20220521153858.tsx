        ...
        <article className={style()}>
          <form className={style('formAddMovie')} onSubmit={handleSubmitToLocalStorage}>
            <div>
              ...
              {
                planetsList && <PlanetsList planetsList={planetsList} />
              }
              <BoxSearchInput
                label="Add Planet"
              ...
              <ul className="suggestionWrapper">
                { suggestions
                  && <SuggestionsList suggestions={suggestions} onClick={() => suggestionSelected(value as unknown as MouseEvent)} />
...
function value(value: any): (event: any) => void {
