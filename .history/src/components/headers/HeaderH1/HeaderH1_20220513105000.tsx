...
function HeaderH1() {
  return (
    <div className={style()}>
      ...
      <img className={style('letters-1')} src={e} alt="Recruitment task" />
      <img className={style('letters-1')} src={en} alt="Recruitment task" />
      <img className={style('letters-1')} src={d} alt="Recruitment task" />
    </div>
  );
}
