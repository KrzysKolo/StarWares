...
console.log('aaa', state)
  return (
    <div className={style()}>
      {state.map((item: { title: string | React.ReactElement<string | React.JSXElementConstructor<string>> | React.ReactFragment | React.ReactPortal; }, i: React.Key | null) => <div key={i}>
