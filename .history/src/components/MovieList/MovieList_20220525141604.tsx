...
import { getAllFilmsLocalStorage, getFilmsLocalStorage } from '../../features/filmsFromLocalStorage/filmsFromLocalStorageSlice';
...
const MovieList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getFilmsFromApi(tabFilmStorage))
  }, [state]);
